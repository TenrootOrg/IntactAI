...
# (to install a different release, replace intact-20260825 with its tag)
curl -fL "https://github.com/TenrootOrg/IntactAI/archive/refs/tags/intact-20260825.tar.gz" -o intact-20260825.tar.gz
mkdir -p intact && tar -xzf intact-20260825.tar.gz --strip-components=1 -C intact
bash intact/scripts/prepare_package.sh intact-20260825 .   # writes intact-20260825-package.tar
tar -czf intact.tar.gz intact                               # one file to carry across
```

Carry **both** `intact.tar.gz` and `intact-20260825-package.tar` across —
...
sudo bash install.sh --package ../intact-20260825-package.tar
```

`--package` is repeatable and also takes a directory of per-module assets. If
Docker is not already installed, carry the release's `intact-20260825-system-bundle.tar`
...
copy-paste; **to target a different release, replace `intact-20260825` with
...
cd ~
curl -fL "https://github.com/TenrootOrg/IntactAI/archive/refs/tags/intact-20260825.tar.gz" -o intact-20260825.tar.gz
mkdir -p intact-20260825 && tar -xzf intact-20260825.tar.gz --strip-components=1 -C intact-20260825
cd ~ && sudo bash intact-20260825/scripts/upgrade.sh intact-20260825 --root ./intact
```
...
bash intact-20260825/scripts/prepare_package.sh intact-20260825 .   # -> intact-20260825-package.tar
tar -czf intact-20260825-checkout.tar.gz intact-20260825            # the release folder, as one file
```

Carry **both** `intact-20260825-checkout.tar.gz` and `intact-20260825-package.tar`
...
```bash
cd ~
tar -xzf intact-20260825-checkout.tar.gz
cd ~ && sudo bash intact-20260825/scripts/upgrade.sh --package intact-20260825-package.tar --root ./intact
```
