...
def build_runner(ctx, cfg):
    ...
    # The cloud modules' OFFLINE path: no credentials, no network, and
    # the only coverage AWS/Azure have ever had.
    cloud.register(runner, cfg)
    ...
    # The artifact operators send to vendors. wrapup already collected it
    # and asserted nothing about it.
    support.register(runner, cfg)
