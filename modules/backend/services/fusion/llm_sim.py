...
REPORT_SYSTEM_PROMPT_FOCUSED = (
    ...
    "\n"
    "scope.findings is the case TOTAL; scope.findings_shown is how many reached you. "
    "When findings_shown < findings you are reading a SAMPLE: never present the "
    "sampled count as the case's finding count.\n"
