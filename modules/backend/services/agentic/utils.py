...
TIMESTAMP_FIELDS = [
    ...
    # Write timestamps
    'LastWriteTime', 'KeyLastWriteTimestamp',
    # Execution timestamps
    'StartTime', 'EndTime', 'Runtime', 'LastRunTimes', 'LastExecutionTime',
    'LastUsedTimeStart', 'LastUsedTimeStop', 'CompletionTimeUTC',
    # NTFS MFT timestamps ($SI = 0x10, $FN = 0x30)
    ...
    # System timestamps
    'SystemTime', 'AttrSystemTime', 'AttrTime', 'ExpiryTime',
    # Unix timestamps
    'Mtime', 'mtime', 'MTime', 'Atime', 'atime', 'Ctime', 'ctime', 'Btime', 'btime',
    'FileMtime',
    # Date fields
    'Date', 'date', 'InstallDate', 'DateLastUsed',
    # Browser timestamps
    'VisitTime', 'LastActivated', 'LastActivityView',
    # Legacy/alternate names
    'SourceCreated', 'SourceModified', 'SourceAccessed',
    'SI_LastModified0x10', 'SI_LastAccess0x10', 'FN_LastModified0x30',
    'TimeCreated', 'TimeGenerated', 'RecordTime', 'LogTime',
    'ZipTimestamp', 'FirstSeen', 'LastSeen', 'Firstseen',
]
...
def find_field_recursive(row, field_names, parent_path=''):
    """Recursively find a field in row, including nested objects.
