...
@system_bp.route('/api/upgrade/status', methods=['GET'])
def get_upgrade_status():
    """Get current and latest versions for all modules."""
    try:
        from services.upgrade_service import get_current_versions, get_latest_versions
...
@system_bp.route('/api/upgrade/start', methods=['POST'])
def start_upgrade():
...
@system_bp.route('/api/upgrade/package-info', methods=['POST'])
def get_upgrade_package_info():
    ...
    try:
        ...
        from services.upgrade_service import get_package_info
...
@system_bp.route('/api/upgrade/offline', methods=['POST'])
def start_offline_upgrade():
    ...
    try:
        ...
        def run_offline_upgrade():
            try:
                from services.upgrade_service import run_offline_upgrade_workflow
